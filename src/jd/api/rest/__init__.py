...
from jd.api.rest.UnionOpenExchangeMediaReportdataFileQueryRequest import UnionOpenExchangeMediaReportdataFileQueryRequest
...
from jd.api.rest.UnionOpenMcpPromotionRedpacketGetRequest import UnionOpenMcpPromotionRedpacketGetRequest
